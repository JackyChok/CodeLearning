...
def run_test():
    ...
    source1 = 1
    target1 = 6
    result1 = sol.numBusesToDestination(routes1, source1, target1)
    print(f'Test Case 1: {routes1}, {source1}, {target1} -> {result1}')

    # Test Case 2
    routes2 = [[7, 12], [4, 5, 15], [6], [15, 19], [9, 12, 13]]
    source2 = 15
    target2 = 12
    result2 = sol.numBusesToDestination(routes2, source2, target2)
    print(f'Test Case 2: {routes2}, {source2}, {target2} -> {result2}')
