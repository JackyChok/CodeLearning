...
if __name__ == "__main__":
    ...
    result1 = solution.findCriticalAndPseudoCriticalEdges(n1, edges1)
    print("Test Case 1:")
    print("Critical Edges:", result1[0])
    print("Pseudo-Critical Edges:", result1[1])
    print()

    n2 = 4
    edges2 = [[0,1,1],[1,2,1],[2,3,1],[0,3,1]]
    result2 = solution.findCriticalAndPseudoCriticalEdges(n2, edges2)
    print("Test Case 2:")
    print("Critical Edges:", result2[0])
    print("Pseudo-Critical Edges:", result2[1])